...
// in food_safe/test/profile_repository_test.dart.
...
import 'package:food_safe/services/local_photo_store.dart' as _i6;
import 'package:food_safe/services/preferences_service.dart' as _i3;
...
class MockPreferencesService extends _i1.Mock
  ...
  @override
  _i4.Future<void> setUserPhotoPath(String? path) => (super.noSuchMethod(
        Invocation.method(
          #setUserPhotoPath,
          [path],
        ),
  ...
  @override
  _i4.Future<void> setUserPhotoBytes(_i5.Uint8List? bytes) =>
      (super.noSuchMethod(
        Invocation.method(
          #setUserPhotoBytes,
          [bytes],
  ...
  @override
  _i4.Future<void> removeUserPhotoBytes() => (super.noSuchMethod(
        Invocation.method(
          #removeUserPhotoBytes,
          [],
        ),
        returnValue: _i4.Future<void>.value(),
        returnValueForMissingStub: _i4.Future<void>.value(),
...
/// A class which mocks [LocalPhotoStore].
///
/// See the documentation for Mockito's code generation for more information.
class MockLocalPhotoStore extends _i1.Mock implements _i6.LocalPhotoStore {
  @override
  _i4.Future<String> savePhoto(_i2.File? photoFile) => (super.noSuchMethod(
        Invocation.method(
          #savePhoto,
          [photoFile],
        ),
  ...
  @override
  _i4.Future<bool> deletePhoto(String? photoPath) => (super.noSuchMethod(
        Invocation.method(
          #deletePhoto,
          [photoPath],
        ),
  ...
  @override
  _i4.Future<_i2.File?> getPhoto(String? photoPath) => (super.noSuchMethod(
        Invocation.method(
          #getPhoto,
          [photoPath],
        ),
  ...
  @override
  _i4.Future<_i5.Uint8List?> getPhotoBytes(String? photoPath) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPhotoBytes,
          [photoPath],
  ...
  @override
  bool isValidPhotoPath(String? photoPath) => (super.noSuchMethod(
        Invocation.method(
          #isValidPhotoPath,
          [photoPath],
        ),
